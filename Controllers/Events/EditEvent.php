...
class EditEvent implements \JsonSerializable
{
    ...
    public function __construct($event_id, $name, $public, $latitude, $longitude, $start_time, $end_time, $informations, $picture_url, $invited_friends_id)
    {
        ...
        Application::check_variables($start_time, false, true, "^([2][01]|[1][6-9])\d{2}\-([0]\d|[1][0-2])\-([0-2]\d|[3][0-1])(\s([0-1]\d|[2][0-3])(\:[0-5]\d){1,2})?$","Datetime format invalid. Ex: 2017-09-13 13:35:59", ErrorCode::INVALID_DATETIME);
        Application::check_variables($end_time, false, true, "^([2][01]|[1][6-9])\d{2}\-([0]\d|[1][0-2])\-([0-2]\d|[3][0-1])(\s([0-1]\d|[2][0-3])(\:[0-5]\d){1,2})?$","Datetime format invalid. Ex: 2017-09-13 13:35:59", ErrorCode::INVALID_DATETIME);
