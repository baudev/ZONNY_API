...
class UserTest extends TestCase
{
    ...
    public function testNeedToUpdateHisLocation(){
        $entityManager = Database::getEntityManager();
        $user = new User();
        $user->setName("user1");
        $user->setKeyApp("key1");
        ...
        // as the user has any passed events, his level should be the default one
        $this->assertTrue($user->needToUpdateHisLocation());
    ...
    public function testIsCurrentlyToAnEvent(){
        $entityManager = Database::getEntityManager();
        $user = new User();
        $user->setName("user1");
        $user->setKeyApp("key1");
        ...
        // as the user has any passed events, his level should be the default one
        $this->assertFalse($user->isCurrentlyToAnEvent());
